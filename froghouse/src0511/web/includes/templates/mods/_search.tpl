	<div class="maincontainer">
		...
		<div class="rightpart">
			...
			<div class="block">
				<div class="pad">
					<form name="fs" method="get" action="{$siteAdr}page.php">
                    ...
                    <div class="search-form">
						...
						<div class="but"><a href="#" onClick="document.fs.submit();"><img src="{$siteAdr}includes/templates/images/b-search.gif" width="26" height="22" alt="Search"></a></div>
						<div class="spacer s15"><!-- --></div>
						<b>Searching in:</b>
