	<div class="maincontainer">
	   ...
	   {include file="mods/necessities/_left_menu.tpl"}
		...
		<div class="rightpart">
			...
			<div class="title-block"><div>Recent {$list[j].title|ucfirst} Posts</div></div>
			<div class="block">
				<div class="pad">
					...
					<div class="link"><a href="{$list[j].link}">View all {$list[j].title|lower} Posts ({$list[j].cnt})</a></div>
				</div>
			</div>
