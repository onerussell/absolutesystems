<?php /* Smarty version 2.6.12, created on 2006-05-02 01:40:06
         compiled from mods/me/_registration_cities.tpl */ ?>
<select name="UserInfo[<?php echo $this->_tpl_vars['field']; ?>
]" style="font-size:12px;width:150px;" class="sw1" /> 
...
" <?php if ($this->_tpl_vars['st_ar'][$this->_sections['iic']['index']]['city_id'] == $this->_tpl_vars['city_idx']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['st_ar'][$this->_sections['iic']['index']]['name']; ?>
</option>
<?php endfor; else: ?>
