<?php /* Smarty version 2.6.12, created on 2006-05-05 01:49:59
         compiled from mods/_nightlife-review.tpl */ ?>
	<div class="maincontainer">

	   <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "mods/nightlife/_left_menu.tpl", 'smarty_include_vars' => array()));
...
showimg.php?img=<?php echo $this->_tpl_vars['inf']['image']; ?>
','popup','resizable=1,left=0,top=0, width=50, height=50, scrollbars=yes'); return false;"><img src="<?php echo $this->_tpl_vars['siteAdr'];  echo $this->_tpl_vars['imagedir'];  if ($this->_tpl_vars['inf']['cached'] == 1):  echo $this->_tpl_vars['cachedir'];  endif;  echo $this->_tpl_vars['inf']['image']; ?>
" border="0" /></a>
						<?php else: ?>
...
&nbsp;</div>
            ...
            <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "mods/nightlife/_add_comment.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		</div>
