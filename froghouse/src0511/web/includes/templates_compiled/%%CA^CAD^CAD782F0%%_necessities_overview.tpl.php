<?php /* Smarty version 2.6.12, created on 2006-05-09 10:02:19
         compiled from mods/_necessities_overview.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'ucfirst', 'mods/_necessities_overview.tpl', 7, false),array('modifier', 'lower', 'mods/_necessities_overview.tpl', 20, false),)), $this); ?>
...
?>
			<div class="title-block"><div>Recent <?php echo ((is_array($_tmp=$this->_tpl_vars['list'][$this->_sections['j']['index']]['title'])) ? $this->_run_mod_handler('ucfirst', true, $_tmp) : ucfirst($_tmp)); ?>
 Posts</div></div>
			<div class="block">
				<div class="pad">
...
">View all <?php echo ((is_array($_tmp=$this->_tpl_vars['list'][$this->_sections['j']['index']]['title'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)); ?>
 Posts (<?php echo $this->_tpl_vars['list'][$this->_sections['j']['index']]['cnt']; ?>
)</a></div>
				</div>
			</div>
