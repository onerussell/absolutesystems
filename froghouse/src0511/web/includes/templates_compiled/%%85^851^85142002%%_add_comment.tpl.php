<?php /* Smarty version 2.6.12, created on 2006-05-02 04:09:55
         compiled from mods/blog/_add_comment.tpl */ ?>
...
:</div></div><div class="inp"><div><a href="<?php echo $this->_tpl_vars['siteAdr']; ?>
users/<?php echo $this->_tpl_vars['nickname']; ?>
/profile.html"><?php echo $this->_tpl_vars['nickname']; ?>
</a></div></div>
                                                <div class="spacer s9"><!-- --></div>
                                                <?php if (( $this->_tpl_vars['action'] == 'add' )): ?>
                                                <div class="name"><div><?php echo $this->_config[0]['vars']['psubject']; ?>
...
$this->_sections['i']['first']      = ($this->_sections['i']['iteration'] == 1);
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
 if ($this->_tpl_vars['fdata']['elements'][$this->_sections['i']['index']]['type'] == 'text'):  echo $this->_tpl_vars['fdata']['elements'][$this->_sections['i']['index']]['html'];  endif;  endfor; endif; ?></div>
                                                <div class="spacer s9"><!-- --></div>
                                                <?php endif; ?>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
 if ($this->_tpl_vars['fdata']['elements'][$this->_sections['i']['index']]['type'] == 'textarea'):  echo $this->_tpl_vars['fdata']['elements'][$this->_sections['i']['index']]['html'];  endif;  endfor; endif; ?></div>
                                        ...
                                        <?php if (( $this->_tpl_vars['action'] == 'add' )): ?>&nbsp;&nbsp;<a href="<?php echo $this->_tpl_vars['siteAdr']; ?>
page.php?mod=<?php echo $this->_tpl_vars['mod']; ?>
"><?php echo $this->_config[0]['vars']['cancel']; ?>
</a><?php endif; ?>
                                        </div>
                                        </form>
                                </div>
