...
require 'top.php';
    ...
    $gSmarty -> config_load('default.conf', 'Spages');

    #Init
    include 'includes/classes/Spages.php';
    ...
    try
    {
        ...
        switch ($action)
        {
            ...
            case 'change':
                ...
                #Keywords
                $form -> addElement('hidden', 'keyw',   $gSmarty -> _config[0]['vars']['pagekeyw'].' :',   'style="WIDTH: 300px;  HEIGHT: 118px;"');
    ...
    #display and close
    $mc = $gSmarty -> fetch('mods/Spages.tpl');
